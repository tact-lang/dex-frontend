...
const checkImageURL = (url: string) =>
  url.startsWith('http') && (url.endsWith('.png') || url.endsWith('.jpg'))
const checkDecimals = (value: number) => value >= 0 && value <= 255

// Define the onchainFormSpec array with proper typing
