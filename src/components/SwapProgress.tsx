...
const SwapProgress: React.FC<SwapProgressProps> = ({
  ...
  return (
    <div
      ...
      data-testid='swap-progress-overlay'
    >
      <div
        className='swap-progress-modal'
        data-testid='swap-progress-modal'
      >
        ...
        <div
          className='swap-progress-steps'
          data-testid='swap-progress-steps'
        >
          {SWAP_STEPS.map((step) => {
